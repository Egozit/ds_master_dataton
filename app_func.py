# -*- coding: utf-8 -*-
"""02_team_hak_19_10_visualisation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Gj0jzgoJf4N8fG4D52v-vMmQOmUDB_N8
...
def show_objects_on_map(input_df, tpu_data, obj_size=1000, 
                        marker_size=2,
                        zoom=10,
                        obj_as_marker=False,
...
def plot_top_by_col(col, df, n, name, other=False, translit=False, 
    ...
    if horizontally ==True:  
        ...
        ax = sns.barplot(x=temp_df.index, y=temp_df, data=df,
                 palette=palette)
        ax.set(ylabel='Count')
        if len(labels)>0:
