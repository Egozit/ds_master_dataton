...
Преимущество датасета состоит в том, что он актуален на настоящее время, содержит официальные данные и множество дополнительных характеристик.
...
| 28 | **tpu_car_capacity** | Количество машино-мест возле ТПУ | float | 41482 | |
| 29 | **tpu_longitude** | Координаты расположения ТПУ: долгота | dict | 0 | |
| 30 | **tpu_latitude** | Координаты расположения ТПУ: широта | dict | 0 | |
| 31 | **subway_station** | Ближайшая станция метро | str | 11114 | |
| 32 | **subway_line** | Линия ближайшей станции метро | str | 19676 | |
| 33 | **subway_passengers_per_day** | Пассажиропоток ближайшей станции метро | float | 20789 | |
