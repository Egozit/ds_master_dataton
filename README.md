...
Таблица о стоимости аренды и покупки недвижимости по районам была получена на основе анализа сайта [Restate](https://msk.restate.ru/graph/ceny-arendy-kommercheskoy/)
Для уменьшения времени выполнения кода была создана промежуточная таблица `trade_place_tpu.csv`, содержащая информацию о принадлежности тогрового объекта к ТПУ.
